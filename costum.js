...
function ShowInput() {
    ...
    ///####################INSERIMENTO DINAMICO DALLA FORM##############################///
     let nome = document.getElementById("frmNameA").value;
     let cognome = document.getElementById("frmNameB").value;
     let localita = document.getElementById("loc").value;
     //APPUNTI
     ...
     let dataDiNascita = document.getElementById('dateofbirth').value;
     let data = new Date(dataDiNascita);
     let anno = data.getFullYear().toString().substr(-2); //PRENDI LE ULTIME DUE CIFRE
     //var anno = "93";
     ///####################MESE E GIORNO##############################///
     let cod_mese = ['A', 'B', 'C', 'D', 'G', 'H', 'L', 'M', 'P', 'R', 'S', 'T'];
     //var mese = 'Agosto';
